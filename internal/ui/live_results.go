...
func (w *LiveResultWriter) writeLocked() error {
	...
	sb.WriteString(fmt.Sprintf("Speed tests scheduled/started/completed/failed: %d/%d/%d/%d\n\n", s.SpeedTestsScheduled, s.SpeedTestsStarted, s.SpeedTestsCompleted, s.SpeedTestsFailed))
